                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="offset-xl-2 col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <form  method="POST" action="/produits/ajouts">
                            @csrf
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 pr-xl-0 pr-lg-0 pr-md-0  m-b-30">
                                    <div class="product-slider">
										<img class="d-block" src="../images/eco-slider-img-1.png" alt="First slide">
                                        <input name="urlAjout" required pattern="[A-Za-z' -]+">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 pl-xl-0 pl-lg-0 pl-md-0 border-left m-b-30">
                                    <div class="product-details">
                                        <div class="border-bottom pb-3 mb-3">
                                            <h2 class="mb-3"><input type="text" value="" name="nomAjout" required pattern="[A-Za-z' -]+"/></h2>
                                            <h3 class="mb-0 text-primary">$<input type="text" value="" name="prixAjout" required pattern="[0-9]+"></h3>
                                        </div>
                                        <div class="product-size border-bottom">
                                            <h4>Fournisseur</h4>
                                            <input type="text" value="" name="fournisseurAjout" required pattern="[A-Za-z' -]+">
                                            <div class="product-qty">
                                                <h4>Quantité</h4>
                                                <div class="quantity">
                                                    <input type="number" value="" name="quantiteAjout" required pattern="[0-9]+">
                                                </div>
                                            </div>
                                        </div>
